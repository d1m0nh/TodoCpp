...
bool
libtodo::sqlite::operator<(const Value& l, const Value& r) {
...
std::ostream&
libtodo::sqlite::operator <<(std::ostream& os, const Value& v) {
    switch (v.type()) {
        case Value::Type::INT:
...
std::ostream&
libtodo::sqlite::operator <<(std::ostream& os, const vector<Value>& values) {
    os << "(";
...
std::ostream&
libtodo::sqlite::operator <<(std::ostream& os, Value::Type t) {
    switch (t) {
        case Value::Type::NUL:
            return os << "NUL";
        case Value::Type::STRING:
